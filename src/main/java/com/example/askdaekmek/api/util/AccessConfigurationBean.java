...
package com.example.askdaekmek.api.util;

/**
 * Container class to hold configuration data to access the Kuveyt Türk web service backend
 *
 * @author      Fikri Aydemir
 * @version     1.0
 * @since       2018-04-18
...
public final class AccessConfigurationBean implements java.io.Serializable {
    ...
    public static final String DEFAULT_AUTHORIZATION_ENDPOINT = "com/example/askdaekmek/api/connect/authorize";
    public static final String DEFAULT_BASE_ACCESS_TOKEN_URL = "https://idprep.kuveytturk.com.tr/";
    public static final String DEFAULT_ACCESS_TOKEN_ENDPOINT = "com/example/askdaekmek/api/connect/token";
